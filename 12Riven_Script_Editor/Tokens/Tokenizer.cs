...
namespace Riven_Script_Editor.Tokens
{
    static class Tokenizer
    {
        ...
        static public Token trailerToken;
        ...
        static public void OpenFile(string fileName, string fileNameJp)
        {
            ...
            byte[] byteCommand = data.Skip(pos).Take(lenght).ToArray();

            TokenHeader headerToken = new TokenHeader(byteCommand, pos);
            ...
            int trailerLenght = data.Length - trailerStart;
            byteCommand = data.Skip(trailerStart).Take(trailerLenght).ToArray();
            trailerToken = new Token(byteCommand, 0);
        }
        ...
        static public void SaveFile(string filename)
        {
            ...
            // Write to file
            var stream_out = new FileStream(filename + ".TL", FileMode.Create, FileAccess.ReadWrite);
        ...
        static public Token ReadNextToken()
        {
            ...
            switch (opcode)
            {
                case TokenMsgDisp2.Type: return new TokenMsgDisp2(byteCommand, pos);
                case TokenSelectDisp2.Type: return new TokenSelectDisp2(byteCommand, pos);
                case TokenSysMessage.Type: return new TokenSysMessage(byteCommand, pos);
                default: return new Token(byteCommand, pos);
            }
        }
